...
},{}],"AddShape.ts":[function(require,module,exports) {
"use strict";
...
var Rect = /*#__PURE__*/_createClass(function Rect() {
  _classCallCheck(this, Rect);
});
Rect.CONTENTS_NAME = "Rect";
Rect.KBAR_ARG = {
  normal: "Rect",
  onlyFill: "RectFill",
  onlyLine: "RectLine"
...
var Polystar = /*#__PURE__*/_createClass(function Polystar() {
  _classCallCheck(this, Polystar);
});
Polystar.CONTENTS_NAME = "Polystar";
Polystar.KBAR_ARG = {
  normal: "Polystar",
...
Polystar.TYPE = 2;
Polystar.POINTS_SIZE = 6;
Polystar.RADIUS = 250;
Polystar.STROKE_WIDTH = 10;
var Line = /*#__PURE__*/_createClass(function Line() {
  _classCallCheck(this, Line);
});
Line.CONTENTS_NAME = "Line";
Line.KBAR_ARG = {
...
var AddShape = /*#__PURE__*/function () {
  function AddShape() {
  ...
  _createClass(AddShape, [{
    ...
    value: function main() {
      ...
      var shapeLayer = acriveComp.layers.addShape();
      var shapeGroupProp = this.addShapeGroup(shapeLayer);
      var arg = kbar.button.argument;
      switch (arg) {
    ...
    key: "addShapeGroup",
    value: function addShapeGroup(i_shapeLayer) {
      var shapeGroupProp = this.addContents(i_shapeLayer, PropertyName_1.PropertyName.ShapeLayer.Group);
      shapeGroupProp.property(PropertyName_1.PropertyName.ShapeLayer.MaterialOptions).remove();
      return shapeGroupProp;
    }
  }, {
    key: "addContents",
    value: function addContents(i_parentProp, i_contentsName) {
      var contentsProp = i_parentProp.property(PropertyName_1.PropertyName.ShapeLayer.Contents);
      var newContentsProp = contentsProp.addProperty(i_contentsName);
      return newContentsProp;
    }
  }, {
    key: "addCircle",
    value: function addCircle(i_shapeGroupProp) {
      i_shapeGroupProp.name = Circle.CONTENTS_NAME;
      var circleProp = this.addContents(i_shapeGroupProp, PropertyName_1.PropertyName.ShapeLayer.Ellipse);
      var sizeProp = circleProp.property(PropertyName_1.PropertyName.ShapeLayer.EllipseSize);
      sizeProp.setValue([Circle.SIZE.x, Circle.SIZE.y]);
    }
  }, {
    key: "addRect",
    value: function addRect(i_shapeGroupProp) {
      i_shapeGroupProp.name = Rect.CONTENTS_NAME;
      var rectProp = this.addContents(i_shapeGroupProp, PropertyName_1.PropertyName.ShapeLayer.Rect);
      var sizeProp = rectProp.property(PropertyName_1.PropertyName.ShapeLayer.RectSize);
      sizeProp.setValue([Circle.SIZE.x, Circle.SIZE.y]);
    }
  }, {
    key: "addPolystar",
    value: function addPolystar(i_shapeGroupProp) {
      i_shapeGroupProp.name = Polystar.CONTENTS_NAME;
      var polystarProp = this.addContents(i_shapeGroupProp, PropertyName_1.PropertyName.ShapeLayer.Polystar);
      var typeProp = polystarProp.property(PropertyName_1.PropertyName.ShapeLayer.PolystarType);
      var pointsProp = polystarProp.property(PropertyName_1.PropertyName.ShapeLayer.PolystarPoints);
      var radiusProp = polystarProp.property(PropertyName_1.PropertyName.ShapeLayer.PolystarOuterRadius);
    ...
    key: "addLine",
    value: function addLine(i_shapeGroupProp, i_isVertical) {
      var line = new Shape();
      var coordinate = Line.LENGTH / 2;
      line.vertices = i_isVertical ? [[0, coordinate], [0, -coordinate]] : [[coordinate, 0], [-coordinate, 0]];
      i_shapeGroupProp.name = Line.CONTENTS_NAME;
      var pathGroupProp = this.addContents(i_shapeGroupProp, PropertyName_1.PropertyName.ShapeLayer.PathGroup);
      var pathProp = pathGroupProp.property(PropertyName_1.PropertyName.ShapeLayer.Path);
      pathProp.setValue(line);
    }
  }, {
    key: "addFill",
    value: function addFill(i_shapeGroupProp) {
      this.addContents(i_shapeGroupProp, PropertyName_1.PropertyName.ShapeLayer.Fill);
    }
  }, {
    key: "addStroke",
    value: function addStroke(i_shapeGroupProp) {
      var strokeProp = this.addContents(i_shapeGroupProp, PropertyName_1.PropertyName.ShapeLayer.Stroke);
      var widthProp = strokeProp.property(PropertyName_1.PropertyName.ShapeLayer.StrokeWidth);
      widthProp.setValue(Circle.STROKE_WIDTH);
    }
  }, {
    key: "fixScale",
    value: function fixScale(i_layer, i_isVertical) {
      var expression = i_isVertical ? "[100, value[1]]" : "[value[0], 100]";
      var scaleProp = i_layer.transform.scale;
      scaleProp.expression = expression;
    }
  }]);
  return AddShape;
}();
var addShape = new AddShape();
app.beginUndoGroup(addShape.scriptName);
addShape.main();
app.endUndoGroup();
},{"../../Common/Common":"../../Common/Common.ts","../../Common/PropertyName":"../../Common/PropertyName.ts"}]},{},["AddShape.ts"], null)