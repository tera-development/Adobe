...
},{}],"AddScalePixelExpression.ts":[function(require,module,exports) {
"use strict";
...
var AddScalePixelExpression = /*#__PURE__*/function () {
  function AddScalePixelExpression() {
    _classCallCheck(this, AddScalePixelExpression);
    this.scriptName = this.constructor.name;
  }
  _createClass(AddScalePixelExpression, [{
    key: "main",
    value: function main() {
      ...
      var sourceTextLayerScale = sourceTextLayer.scale.value;
      this.addScaleExpression(acriveComp.selectedLayers, sourceTextLayerScale);
    }
  }, {
    ...
    key: "addScaleExpression",
    value: function addScaleExpression(i_layers, i_sourceTextLayerScale) {
      i_layers.forEach(function (layer) {
        layer.selectedProperties.forEach(function (property) {
          if (property instanceof PropertyGroup) return;
          var value = property.value;
          if (isNaN(value)) return;
          var expression = Common_1.Common.loadExpression(ExpressionFile_1.ScalePixel.FILE_PATH);
          expression = expression.replace(ExpressionFile_1.ScalePixel.TEXT_SCALE_X, i_sourceTextLayerScale[0].toString());
          expression = expression.replace(ExpressionFile_1.ScalePixel.TEXT_SCALE_Y, i_sourceTextLayerScale[1].toString());
          expression = expression.replace(ExpressionFile_1.ScalePixel.PIXEL_SIZE, value.toString());
          property.expression = expression;
        });
      });
    }
  }]);
  return AddScalePixelExpression;
}();
var addScalePixelExpression = new AddScalePixelExpression();
app.beginUndoGroup(addScalePixelExpression.scriptName);
addScalePixelExpression.main();
app.endUndoGroup();
},{"../../Common/Common":"../../Common/Common.ts","./ExpressionFile":"ExpressionFile.ts"}]},{},["AddScalePixelExpression.ts"], null)