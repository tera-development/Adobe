...
},{"../../node_modules/extendscript-es5-shim-ts":"../../../node_modules/extendscript-es5-shim-ts/index.js"}],"SelectItemAtProPanel.ts":[function(require,module,exports) {
"use strict";
...
var SelectItemAtProPanel = /*#__PURE__*/function () {
  function SelectItemAtProPanel() {
    _classCallCheck(this, SelectItemAtProPanel);
    this.scriptName = this.constructor.name;
  }
  _createClass(SelectItemAtProPanel, [{
    key: "main",
    value: function main() {
    ...
    key: "unSelectAllItem",
    value: function unSelectAllItem() {
    ...
    key: "selectItem",
    value: function selectItem(i_activeComp) {
      var selectedLayers = i_activeComp.selectedLayers;
      if (selectedLayers.length == 0) {
        i_activeComp.selected = true;
      } else {
        selectedLayers.forEach(function (layer) {
          return layer.source.selected = true;
        });
      }
    }
  }]);
  return SelectItemAtProPanel;
}();
var selectItemAtProPanel = new SelectItemAtProPanel();
app.beginUndoGroup(selectItemAtProPanel.scriptName);
selectItemAtProPanel.main();
app.endUndoGroup();
},{"../../Common/Common":"../../Common/Common.ts"}]},{},["SelectItemAtProPanel.ts"], null)