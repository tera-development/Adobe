...
},{"../../node_modules/extendscript-es5-shim-ts":"../../../node_modules/extendscript-es5-shim-ts/index.js"}],"DeComposeTextComp.ts":[function(require,module,exports) {
"use strict";
...
exports.DeComposeTextComp = void 0;
var Common_1 = require("../../Common/Common");
var DeComposeTextComp = /*#__PURE__*/function () {
  function DeComposeTextComp() {
    _classCallCheck(this, DeComposeTextComp);
    this.scriptName = this.constructor.name;
  }
  _createClass(DeComposeTextComp, [{
    key: "main",
    value: function main() {
    ...
    key: "extractTextComps",
    value: function extractTextComps(i_comp) {
      var comps = [];
    ...
    key: "deCompose",
    value: function deCompose(i_comps) {
      var _this = this;
      i_comps.forEach(function (comp) {
        var usedComps = comp.usedIn;
        usedComps.forEach(function (usedComp) {
          var usedCompLayers = _this.getCompLayers(usedComp, comp);
          usedCompLayers.forEach(function (usedCompLayer) {
            usedCompLayer.selected = true;
            var compLayerIdx = usedCompLayer.index;
            var copiedLayers = _this.copyAllLayer(usedComp, comp, compLayerIdx);
            _this.copyLayerTransform2CopiedLayers(usedCompLayer, copiedLayers);
    ...
    key: "deleteComps",
    value: function deleteComps(i_comps) {
      var _this2 = this;
      i_comps.forEach(function (comp) {
        _this2.deleteItem(comp);
      });
    }
  }, {
    key: "isOnlyTextLayers",
    value: function isOnlyTextLayers(i_comp) {
      var isOnlyTextLayers = true;
      for (var l = 1; l <= i_comp.numLayers; l++) {
    ...
    key: "getCompLayers",
    value: function getCompLayers(i_parentComp, i_childComp) {
      var compLayers = [];
      for (var l = 1; l <= i_parentComp.numLayers; l++) {
        var layer = i_parentComp.layer(l);
    ...
    key: "copyAllLayer",
    value: function copyAllLayer(i_targetComp, i_sourceComp, i_sourceCompLayerIdx) {
      var sourceNumLayers = i_sourceComp.numLayers;
      for (var l = 1; l <= sourceNumLayers; l++) {
        var layer = i_sourceComp.layer(l);
        layer.copyToComp(i_targetComp);
      }
      var copiedLayers = [];
      var newLayerIdx = i_sourceCompLayerIdx + sourceNumLayers;
      for (var _l = newLayerIdx - sourceNumLayers; _l < newLayerIdx; _l++) {
        copiedLayers.push(i_targetComp.layer(_l));
      }
      return copiedLayers;
    }
  }, {
    key: "copyLayerTransform2CopiedLayers",
    value: function copyLayerTransform2CopiedLayers(i_sourceLayer, i_copiedLayers) {
      var comp = i_sourceLayer.containingComp;
      var parent3DLayer = comp.layers.addSolid([0, 0, 0], "tmp", 1920, 1080, 1);
      parent3DLayer.threeDLayer = true;
      Common_1.Common.setParentLayer(parent3DLayer, i_copiedLayers);
      var pTransform = Common_1.Common.getLayerTransform(parent3DLayer);
      var sTransformValue = Common_1.Common.getLayerTransformValue(i_sourceLayer);
      ...
      this.deleteItem(parent3DLayer.source);
    }
  }, {
    key: "releaseParentLayer",
    value: function releaseParentLayer(i_parentLayer, i_layers) {
      i_layers.forEach(function (layer) {
        var wasLocked = layer.locked;
        layer.locked = false;
    ...
    key: "deleteItem",
    value: function deleteItem(i_item) {
  ...
  return DeComposeTextComp;
}();
exports.DeComposeTextComp = DeComposeTextComp;
},{"../../Common/Common":"../../Common/Common.ts"}],"ReplaceFile2MediaFolderFile.ts":[function(require,module,exports) {
"use strict";
...
},{}],"TrimCompDuration.ts":[function(require,module,exports) {
"use strict";
...
exports.TrimCompDuration = void 0;
var Common_1 = require("../../Common/Common");
var TrimCompDuration = /*#__PURE__*/function () {
  function TrimCompDuration() {
    _classCallCheck(this, TrimCompDuration);
    this.scriptName = this.constructor.name;
  }
  _createClass(TrimCompDuration, [{
    key: "main",
    value: function main() {
      var _this = this;
      ...
      comps.forEach(function (comp) {
        _this.trimIncludedCompDuration(comp);
      });
    }
  }, {
    key: "trimIncludedCompDuration",
    value: function trimIncludedCompDuration(i_comp) {
      for (var l = 1; l <= i_comp.numLayers; l++) {
        var item = i_comp.layer(l).source;
        if (item instanceof CompItem) {
    ...
    key: "trimAndMoveStartPoint",
    value: function trimAndMoveStartPoint(i_comp) {
      var startPoint = this.trimCompDuration(i_comp);
      if (startPoint == 0) return;
      this.moveStartPoint(i_comp, startPoint);
    }
  }, {
    key: "trimCompDuration",
    value: function trimCompDuration(i_comp) {
      ...
      for (var _l = 1; _l <= i_comp.numLayers; _l++) {
        var _layer = i_comp.layer(_l);
        _layer.startTime -= minInPoint;
      }
      i_comp.duration = maxOutPoint - minInPoint;
      var compStartTime = minInPoint;
      return compStartTime;
    }
  }, {
    key: "moveStartPoint",
    value: function moveStartPoint(i_comp, i_compStartPoint) {
      var compLayers = Common_1.Common.extractCompLayers(i_comp);
      compLayers.forEach(function (compLayer) {
        compLayer.startTime = i_compStartPoint;
      });
    }
  }]);
  return TrimCompDuration;
}();
exports.TrimCompDuration = TrimCompDuration;
},{"../../Common/Common":"../../Common/Common.ts"}],"SortLayer.ts":[function(require,module,exports) {
"use strict";
...
},{}],"PrLink.ts":[function(require,module,exports) {
"use strict";
...
var Common_1 = require("../../Common/Common");
var DeComposeTextComp_1 = require("./DeComposeTextComp");
var ReplaceFile2MediaFolderFile_1 = require("./ReplaceFile2MediaFolderFile");
var TrimCompDuration_1 = require("./TrimCompDuration");
var SortLayer_1 = require("./SortLayer");
var PrLink = /*#__PURE__*/function () {
  function PrLink() {
    _classCallCheck(this, PrLink);
    this.scriptName = this.constructor.name;
  }
  _createClass(PrLink, [{
    key: "main",
    value: function main() {
      if (!Common_1.Common.isActiveComp()) return;
      var deComposeTextComp = new DeComposeTextComp_1.DeComposeTextComp();
      var replaceFile2MediaFolderFile = new ReplaceFile2MediaFolderFile_1.ReplaceFile2MediaFolderFile();
      var trimCompDuration = new TrimCompDuration_1.TrimCompDuration();
      var sortLayer = new SortLayer_1.SortLayer();
...
var prLink = new PrLink();
app.beginUndoGroup(prLink.scriptName);
prLink.main();
app.endUndoGroup();
},{"../../Common/Common":"../../Common/Common.ts","./DeComposeTextComp":"DeComposeTextComp.ts","./ReplaceFile2MediaFolderFile":"ReplaceFile2MediaFolderFile.ts","./TrimCompDuration":"TrimCompDuration.ts","./SortLayer":"SortLayer.ts"}]},{},["PrLink.ts"], null)