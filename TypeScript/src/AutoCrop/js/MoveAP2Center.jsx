...
},{"../../node_modules/extendscript-es5-shim-ts":"../../../node_modules/extendscript-es5-shim-ts/index.js"}],"MoveAP2Center.ts":[function(require,module,exports) {
"use strict";
...
var MoveAP2Center = /*#__PURE__*/function () {
  function MoveAP2Center() {
    _classCallCheck(this, MoveAP2Center);
    this.scriptName = this.constructor.name;
  }
  _createClass(MoveAP2Center, [{
    key: "main",
    value: function main() {
      ...
      comps.forEach(function (comp) {
        ...
        compLayers.forEach(function (compLayer) {
          Common_1.Common.moveAP2Center(compLayer);
        });
      });
    }
  }]);
  return MoveAP2Center;
}();
var moveAP2Center = new MoveAP2Center();
app.beginUndoGroup(moveAP2Center.scriptName);
moveAP2Center.main();
app.endUndoGroup();
},{"../../Common/Common":"../../Common/Common.ts"}]},{},["MoveAP2Center.ts"], null)