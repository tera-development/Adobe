...
Common.EXPRESSION_DIR = "C:\\Users\\tera\\Videos\\Adobe\\03_Common\\04_Script\\03_expression";
exports.Common = Common;
},{"../../node_modules/extendscript-es5-shim-ts":"../../../node_modules/extendscript-es5-shim-ts/index.js"}],"ScaleComp2DefaultSize.ts":[function(require,module,exports) {
"use strict";
...
var ScaleComp2DefaultSize = /*#__PURE__*/function () {
  function ScaleComp2DefaultSize() {
    _classCallCheck(this, ScaleComp2DefaultSize);
    this.defaultWidth = 1920;
    this.defaultHeight = 1080;
    this.scriptName = this.constructor.name;
  }
  _createClass(ScaleComp2DefaultSize, [{
    key: "main",
    value: function main() {
      var _this = this;
      ...
      comps.forEach(function (comp) {
        var compLayers = Common_1.Common.extractCompLayers(comp);
        var layerInfos = _this.moveLayersAP2Center(compLayers);
        _this.scaleCompSize(comp);
        _this.returnAP(compLayers, layerInfos);
      });
    }
  }, {
    key: "moveLayersAP2Center",
    value: function moveLayersAP2Center(i_layers) {
      var layerInfos = [];
      i_layers.forEach(function (layer) {
        var transformValue = Common_1.Common.getLayerTransformValue(layer);
        var rect = layer.sourceRectAtTime(0, false);
        layerInfos.push({
          transformValue: transformValue,
          rect: rect
        });
        Common_1.Common.moveAP2Center(layer);
      });
      return layerInfos;
    }
  }, {
    key: "scaleCompSize",
    value: function scaleCompSize(i_comp) {
      ...
      Common_1.Common.setParentLayer(parent3DLayer, i_comp.layers);
      var newWidth = i_comp.width < this.defaultWidth ? this.defaultWidth : i_comp.width;
      var newHeight = i_comp.height < this.defaultHeight ? this.defaultHeight : i_comp.height;
    ...
    key: "returnAP",
    value: function returnAP(i_layers, i_layerInfos) {
      i_layers.forEach(function (layer, i) {
        var layerInfo = i_layerInfos[i];
        var trfValue = layerInfo.transformValue;
        var rect = layerInfo.rect;
        var currentTrfValue = Common_1.Common.getLayerTransformValue(layer);
        var newApX = currentTrfValue.anchorPointValue[0] + trfValue.anchorPointValue[0] - rect.width / 2;
        var newApY = currentTrfValue.anchorPointValue[1] + trfValue.anchorPointValue[1] - rect.height / 2;
        var newApZ = trfValue.anchorPointValue[2];
        var newPosX = trfValue.positionValue[0];
        var newPosY = trfValue.positionValue[1];
        var newPosZ = trfValue.positionValue[2];
        layer.anchorPoint.setValueAtTime(0, [newApX, newApY, newApZ]);
        layer.position.setValueAtTime(0, [newPosX, newPosY, newPosZ]);
      });
    }
  }]);
  return ScaleComp2DefaultSize;
}();
var scaleComp2DefaultSize = new ScaleComp2DefaultSize();
app.beginUndoGroup(scaleComp2DefaultSize.scriptName);
scaleComp2DefaultSize.main();
app.endUndoGroup();
},{"../../Common/Common":"../../Common/Common.ts"}]},{},["ScaleComp2DefaultSize.ts"], null)