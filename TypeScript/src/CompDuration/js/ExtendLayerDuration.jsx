...
},{"../../node_modules/extendscript-es5-shim-ts":"../../../node_modules/extendscript-es5-shim-ts/index.js"}],"ExtendLayerDuration.ts":[function(require,module,exports) {
"use strict";
...
var ExtendLayerDuration = /*#__PURE__*/function () {
  function ExtendLayerDuration() {
    _classCallCheck(this, ExtendLayerDuration);
    this.scriptName = this.constructor.name;
  }
  _createClass(ExtendLayerDuration, [{
    key: "main",
    value: function main() {
      var _this = this;
      ...
      layers.forEach(function (layer) {
        _this.extendLayerDuration(layer, acriveComp.duration);
      });
    }
  }, {
    key: "extendLayerDuration",
    value: function extendLayerDuration(i_layer, i_compDuration) {
      var diff = i_compDuration - i_layer.outPoint;
      i_layer.outPoint += diff;
    }
  }]);
  return ExtendLayerDuration;
}();
var extendLayerDuration = new ExtendLayerDuration();
app.beginUndoGroup(extendLayerDuration.scriptName);
extendLayerDuration.main();
app.endUndoGroup();
},{"../../Common/Common":"../../Common/Common.ts"}]},{},["ExtendLayerDuration.ts"], null)