...
},{"../../node_modules/extendscript-es5-shim-ts":"../../../node_modules/extendscript-es5-shim-ts/index.js"}],"TrimLayerDuration.ts":[function(require,module,exports) {
"use strict";
...
var TrimCompDuration = /*#__PURE__*/function () {
  ...
  _createClass(TrimCompDuration, [{
    ...
    value: function main() {
      ...
      var layers = acriveComp.selectedLayers;
      if (layers.length === 0) {
        alert("Select layer.");
        return;
      }
      var palette = this.showUI(layers, acriveComp.frameRate);
      if (palette == null) {
    ...
    key: "showUI",
    value: function showUI(i_layers, i_frameRate) {
      var _this = this;
      ...
      var input = group.add("edittext");
      var currentDuration = timeToCurrentFormat(i_layers[0].outPoint - i_layers[0].inPoint, i_frameRate);
      ...
      okBtn.text = "OK";
      palette.defaultElement = okBtn;
      if (this.IS_DEBUG) {
        this.onOKClick(i_layers, i_frameRate, "00:01:00", true);
      } else {
        okBtn.onClick = function () {
          palette.close();
          _this.onOKClick(i_layers, i_frameRate, input.text, checkBox.value);
        };
      }
    ...
    key: "onOKClick",
    value: function onOKClick(i_layers, i_frameRate, i_inputText, i_isExtend) {
      var _this2 = this;
      var duration = currentFormatToTime(i_inputText, i_frameRate);
      if (duration === 0) {
      ...
      i_layers.forEach(function (layer) {
        _this2.trimDuration(layer, duration, i_isExtend);
      });
      app.endUndoGroup();
    }
  }, {
    key: "trimDuration",
    value: function trimDuration(i_layer, i_duration, i_isExtend) {
      var basePoint = i_isExtend ? i_layer.outPoint : i_layer.inPoint;
      var outPoint = basePoint + i_duration;
...
var trimCompDuration = new TrimCompDuration();
trimCompDuration.main();
},{"../../Common/Common":"../../Common/Common.ts"}]},{},["TrimLayerDuration.ts"], null)