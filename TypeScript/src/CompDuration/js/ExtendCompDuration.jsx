...
},{"../../node_modules/extendscript-es5-shim-ts":"../../../node_modules/extendscript-es5-shim-ts/index.js"}],"ExtendCompDuration.ts":[function(require,module,exports) {
"use strict";
...
var ExtendCompDuration = /*#__PURE__*/function () {
  function ExtendCompDuration() {
    _classCallCheck(this, ExtendCompDuration);
    this.DURATION_DIFF = 60;
    this.scriptName = this.constructor.name;
  }
  _createClass(ExtendCompDuration, [{
    key: "main",
    value: function main() {
    ...
    key: "extendCompDuration",
    value: function extendCompDuration(i_comp) {
      i_comp.duration += this.DURATION_DIFF;
    }
  }]);
  return ExtendCompDuration;
}();
var extendCompDuration = new ExtendCompDuration();
app.beginUndoGroup(extendCompDuration.scriptName);
extendCompDuration.main();
app.endUndoGroup();
},{"../../Common/Common":"../../Common/Common.ts"}]},{},["ExtendCompDuration.ts"], null)